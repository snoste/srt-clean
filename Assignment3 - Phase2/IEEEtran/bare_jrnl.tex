...
\section{Conclusion}
It is possible to conclude that the triple A9 has better performance that the A15-A9. However, the performance of a CPU really rely on multiple factor such as compiler, architecture, how the program is written. Moreover, from our results is it possible to see that the A15-A9 processor was better in running the code without using thread. On the other hand, the optimized code was making the triple A9 execution much faster.
\end{document}
